...
# Based on above p-value, build a model without 3P%, FTM, FTA, STL, RK:
model3 <- lm(SALARY~GP+MIN+PTS+FGA+`FG%`+`3PM`+`3PA`+`FT%`+REB+AST+BLK+TO+DD2+TD3+PER, data = Final_Dataset)
summary(model3)
